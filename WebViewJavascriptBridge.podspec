Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/qdsddev/WebViewJavascriptBridge'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'marcuswestin' => 'marcus.westin@gmail.com' }
  s.source       = { :git => 'https://github.com/qdsddev/WebViewJavascriptBridge.git', :tag => 'v'+s.version.to_s }
  s.platforms    = { :ios => "13.0", :osx => "" }
  s.requires_arc = true
